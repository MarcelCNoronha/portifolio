        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex items-center justify-center mt-8 md:mt-10">
            <a
              ...
              className="inline-flex items-center gap-3 bg-blue-600 text-white font-bold py-4 px-6 text-lg rounded-full shadow-lg hover:bg-blue-700 hover:scale-105 transition duration-300 ease-in-out transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-offset-2"
            >
