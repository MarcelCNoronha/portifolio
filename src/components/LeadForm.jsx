  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div role="dialog" aria-modal="true" aria-label="Formulário para baixar checklist" className="relative max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 z-10">
        ...
        <p className="text-sm mb-4 text-gray-600 dark:text-gray-300">Deixe seu email e enviarei o checklist por email, além de abrir a versão para download imediatamente.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <button type="submit" className="inline-block bg-blue-600 text-white font-bold py-2 px-4 rounded-full hover:bg-blue-700 transition-colors">Enviar e Baixar</button>
            <a href="/lead-magnet.html" target="_blank" rel="noopener noreferrer" className="inline-block bg-gray-200 text-gray-800 font-semibold py-2 px-3 rounded-full hover:bg-gray-300">Abrir versão para impressão</a>
          </div>
        </form>
