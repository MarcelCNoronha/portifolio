  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center">
        ...
        >
          Na <strong className="text-blue-600">Assessoria Digital</strong>,
          somos apaixonados em transformar negócios através do poder do
          marketing digital. Acreditamos que cada empresa, independentemente do
          tamanho, merece uma presença online forte e estratégica para alcançar
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">
          <div className="text-left">
            ...
            >
              <li>
                <strong>Inovação:</strong> Buscamos constantemente as melhores e
                mais recentes tendências do mercado.
              </li>
              <li>
                <strong>Resultados:</strong> Nosso compromisso é com o
                crescimento e o sucesso dos nossos clientes.
              </li>
              <li>
                <strong>Transparência:</strong> Mantemos uma comunicação clara e
                honesta em todas as etapas.
              </li>
              <li>
                <strong>Parceria:</strong> Construímos relacionamentos sólidos e
                duradouros com nossos clientes.
              </li>
              <li>
                <strong>Excelência:</strong> Entregamos serviços de alta
                qualidade, com atenção a cada detalhe.
              </li>
            </ul>
          </div>
          <div>
