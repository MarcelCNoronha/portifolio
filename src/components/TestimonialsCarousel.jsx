      ...
      <div className="container mx-auto px-4 text-justify">
        ...
        <div className="max-w-3xl mx-auto">
          <Carousel showArrows={false} showThumbs={false} showStatus={false} infiniteLoop={true} autoPlay={true} interval={6000}>
            {testimonials.map((t) => (
              <div key={t.id} className={`p-6 rounded-xl flex flex-col items-center justify-center min-h-[300px] ${theme === "dark" ? "bg-gray-700 text-gray-100" : "bg-white text-gray-800"}`}> 
